...
--   - DBT PROJECT object AMAR_WORKSHOP.SILVER.AMAR_BANK_WORKSHOP sudah ter-deploy (LAB 2)
...
CREATE OR REPLACE TASK BRONZE.TASK_DBT_SNAPSHOT
  ...
  AS
    EXECUTE DBT PROJECT AMAR_WORKSHOP.SILVER.AMAR_BANK_WORKSHOP ARGS='snapshot';
